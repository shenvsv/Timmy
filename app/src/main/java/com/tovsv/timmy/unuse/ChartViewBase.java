...
/**
 * Created by shenvsv on 14/10/25.
 */

public abstract class ChartViewBase <T extends ChartData<? extends DataSet<? extends Entry>>>
        extends Chart<T> {
    ...
    public ChartViewBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init() {
        ...
        mListener = new ChartTouchListener(this);
    }
